...
import com.bcnx.ui.acquirer.action.CwdMsgSaveAction;

public class CwdMsgPane extends JPanel{
	...
	public CwdMsgPane(){
		...
		de21Label = new JLabel("DE22");
		de21Label.setFont(new Font("Courier New", Font.BOLD, 12));
		
		de19Label = new JLabel("DE19");
		de19Label.setFont(new Font("Courier New", Font.BOLD, 12));
		
		de42Field = new JTextField();
		de42Field.setText("1xxx yyyy zzzz");
		...
		de52Field.setText("1234567890ABCEF");
		...
		saveButton.addActionListener(new CwdMsgSaveAction(de02Box,de03Box,de04Field,de28Field,de32Box,de41Field,de42Field,de43Field,de52Field));
				...
				.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(de03Box, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(de21Label, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									.addGap(3)
									.addComponent(de21Label, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE))
								.addGroup(groupLayout.createSequentialGroup()
									.addGap(1)
	...
	public void initComponent() {
		...
		CwdMsgService cwdMsgService = (CwdMsgService) context.getBean("cwdMsgService");
