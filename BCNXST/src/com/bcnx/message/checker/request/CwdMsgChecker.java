...
public class CwdMsgChecker extends MessageCheckerImp implements MessageChecker{
	...
	public byte[] checkMessage(ISOMsg isoMsg) throws ISOException {
		...
		if(chk){
			logger.info("============ Cash Withdrawal Message ============");
			...
			String de52 = isoMsg.getString(52);
			...
			chk = MessageDefinition.checkField52(de52);
			printChecker(chk, 52, de52);
