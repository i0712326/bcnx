...
public class PinBlockCryptoImp implements PinBlockCrypto {
	// NOTES: KEY MUST BE 32 OR 48 CHAR.
	// IT CAN BE 16, BUT REPEAT FIRST 16 TO MAKE IT 32.
	private static final String KEY = "1705CA969E964BE284CAF85C36775D84";
	...
	private static void init() {
		PinBlockCryptoImp objSelf = new PinBlockCryptoImp();
	...
	private int binHexToBytes(String sBinHex, byte[] data, int nSrcPos,
			int nNumOfBytes) {
